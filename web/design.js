...
const titles={feed:'Recent token scans',wallet:'Wallet & fee income',trades:'Trading activity',runway:'Operating runway',brain:'Rule performance',lab:'Strategy comparisons',paper:'Paper portfolio',advisor:'Advisor',bad:'Creator signals',causes:'Giving',voice:'Field notes'};for(const [k,v] of Object.entries(titles)){const el=document.querySelector(`[data-panel="${k}"] .ttl`);if(el)el.textContent=v}
